...
<section> 
    <div class="centered-telegraph-box box">
      <img class="telegraph-sign" src="{base}/images/TelegraphAveSignPlain.png" alt="Sign.">
    </div>
</section>

<!-- Section 2: Street Vendors-->
<section class="background-tint-mobile bottom-margin">
    <div class="two-column-layout">

        <div class="box">
            <h1> Street Vendors</h1>
            <p>Zaffar Mahmoud has been laying out his jewelry to sell on Telegraph Avenue since 1980, back when the street still felt like an open-air gallery. In those days, the sidewalks were filled with other vendors sharing handmade wares. That world hasn’t disappeared, but it’s gotten quieter. Over time, Mahmoud says selling here has become less about craft and more about keeping up— faster products and shifts in taste have made fewer vendors willing or able to stay. </p>
            <p>Many have packed up, moved on, or changed what they make just to get by. Mahmoud remains a constant on a street that rarely is, one where the value wasn’t just in what you bought, but in who you met along the way. </p>
        </div>
...
<section class="bottom-margin background-tint-mobile">
